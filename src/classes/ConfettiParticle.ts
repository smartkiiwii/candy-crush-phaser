export default class ConfettiProcessor extends Phaser.GameObjects.Particles.ParticleProcessor {
     ...
     */
    constructor(config: { strength?: number; x?: number; y?: number; active?: boolean }) {
